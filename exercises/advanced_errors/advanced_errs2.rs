...
impl Display for ParseClimateError {
    // Complete this function so that it produces the correct strings
...
impl FromStr for Climate {
    ...
    // Complete this function by making it handle the missing error
    // cases.
